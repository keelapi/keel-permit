...
![Spec version](https://img.shields.io/badge/spec-1.20.0-blue)
...
git archive --prefix=keel-permit-1.20.0/ --format=tar.gz v1.20.0 | sha256sum
...
```sh
gh attestation verify keel-permit-1.20.0.tar.gz -R keelapi/keel-permit
```
